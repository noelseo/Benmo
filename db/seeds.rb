...
megan = User.create({ first_name: 'Megan', last_name: 'Laney', username: 'm-l-1', email: 'megan@benmo.com', phone_number: '2393921049', password: 'password', balance: 1950.31 })
...
darryl = User.create({ first_name: 'Darryl', last_name: 'Nguyen', username: 'd-n-2', email: 'darryl@benmo.com', phone_number: '9203911930', password: 'password', balance: 308.19 })
...
transaction1 = Transaction.create!({ amount: 100.00, sender_id: ben.id, receiver_id: megan.id })
...
transaction4 = Transaction.create!({ amount: 19.92, sender_id: jon.id, receiver_id: megan.id })
transaction5 = Transaction.create!({ amount: 593.10, sender_id: chris.id, receiver_id: ben.id })
transaction6 = Transaction.create!({ amount: 278.27, sender_id: megan.id, receiver_id: ben.id })
